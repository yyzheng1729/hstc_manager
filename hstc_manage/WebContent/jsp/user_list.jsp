		...
		function displayData(data){
			...
			for( i in data ){	
				str += '<tr class="text-c">'+
				       ...
				       '<td>'+'<img width="120" class="picture-thumb" src='+data[i].avatarurl+'>'+'</td>'+
				       '<td class="f-14 td-manage">'+
				       '<a style="text-decoration:none" class="ml-5" onclick="del(this,'+data[i].openid+')" href="javascript:;" title="删除"><i style="font-size:35px" class="Hui-iconfont">&#xe6e2;</i></a>'+
				       '</td>'+
				       '</tr>';
			}
			tbody.innerHTML = str;
